...
class ProductController extends Controller
{
    ...
    {
        $response = Http::withOptions(['verify' => false])->post($this->apiUrl, $request->validated());
    ...
    {
        $response = Http::withOptions(['verify' => false])->get("$this->apiUrl/$id");
        if ($response->successful()) {
    ...
    {
        $response = Http::withOptions(['verify' => false])->put("$this->apiUrl/$id", $request->validated());
    ...
    {
        $response = Http::withOptions(['verify' => false])->delete("$this->apiUrl/$id");
